...
function restart() {
	Connect4.utils.draw("#animate", 500, 500);
}
...
Connect4.utils = {
	...
	getNextPosition: function () {
		var circleCol = Connect4.utils.getRandomInt(0, 7);
